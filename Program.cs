...
namespace Game
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            AnimalDetails animalDetails = ReadAnimalCharacteristics();

            //Match the animal details with the characteristics.
            if (animalDetails != null)
            {
                AnimalDetails matchingAnimal = animals.FindAll(delegate (AnimalDetails a) { return a.Soundex == animalDetails.Soundex; }).FirstOrDefault();
                if (matchingAnimal != null)
                    Console.WriteLine("Here is the animal you are looking for : " + matchingAnimal.AnimalName);
                else
        ...
        /// </summary>
        /// <returns></returns>
        private static AnimalDetails ReadAnimalCharacteristics()
        {
            AnimalDetails animalInfo = new AnimalDetails();
